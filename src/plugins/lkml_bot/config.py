...
class PluginConfig(BaseLKMLConfig):
    ...
    thread_cleanup_interval_minutes: int = 60  # 清理任务执行间隔（分钟）
    ...
    def from_env(cls, database_url=None) -> "PluginConfig":
        ...
        thread_cleanup_interval_minutes = int(
            os.getenv("LKML_THREAD_CLEANUP_INTERVAL_MINUTES", "60")
        )
        ...
        return cls(
            ...
            thread_cleanup_interval_minutes=thread_cleanup_interval_minutes,
